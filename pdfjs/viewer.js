...
function webViewerInitialized() {
  ...
  file = window['documentUrlToLoad'] ? window['documentUrlToLoad'] : 'file' in params ? params.file : _app_options.AppOptions.get('defaultUrl');
  if (window['forceDocumentValidation']) {
...
var defaultOptions = {
  ...
  workerSrc: {
    value: 'https://rhocode.github.io/js/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
